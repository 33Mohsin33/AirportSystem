...
//Tu chwal aadmi h mer acode copy kiya h
void pushpop()
...
cout << "\t\tID       : " << i+1 << "\t\tDeparture Location : " <<
		arpln[i].
		location << endl << endl <<
...
cout << "\t\t\t  ||      BOOKING is closed!  Try Later   ||\n";
